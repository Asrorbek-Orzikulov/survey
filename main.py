...
# Question 21
info_21 = tk.LabelFrame(root, borderwidth=0, highlightthickness=0, padx=10, pady=10)
info_21.pack()
question_21 = tk.IntVar(info_21)
question_21.set("Президент")
label_21 = tk.Label(info_21, text="21. Нурдинжон Исмоилов, Ўзбекистон Республикаси Олий Мажлиси Қонунчилик палатасининг спикери.")
label_21.grid(row=4, column=0, padx=10, pady=10)
button_21_1 = tk.Radiobutton(info_21, text="1", value=1, variable=question_21)
button_21_1.grid(row=4, column=1, padx=10, pady=10)
button_21_2 = tk.Radiobutton(info_21, text="2", value=2, variable=question_21)
button_21_2.grid(row=4, column=2, padx=10, pady=10)
button_21_3 = tk.Radiobutton(info_21, text="3", value=3, variable=question_21)
button_21_3.grid(row=4, column=3, padx=10, pady=10)
button_21_4 = tk.Radiobutton(info_21, text="4", value=4, variable=question_21)
button_21_4.grid(row=4, column=4, padx=10, pady=10)

# Question 22
info_22 = tk.LabelFrame(root, borderwidth=0, highlightthickness=0, padx=10, pady=10)
info_22.pack()
question_22 = tk.IntVar(info_22)
question_22.set("Президент")
label_22 = tk.Label(info_22, text="22. Актам Хаитов, Ўзбекистон Либерал-демократик партияси етакчиси")
label_22.grid(row=4, column=0, padx=10, pady=10)
button_22_1 = tk.Radiobutton(info_22, text="1", value=1, variable=question_22)
button_22_1.grid(row=4, column=1, padx=10, pady=10)
button_22_2 = tk.Radiobutton(info_22, text="2", value=2, variable=question_22)
button_22_2.grid(row=4, column=2, padx=10, pady=10)
button_22_3 = tk.Radiobutton(info_22, text="3", value=3, variable=question_22)
button_22_3.grid(row=4, column=3, padx=10, pady=10)
button_22_4 = tk.Radiobutton(info_22, text="4", value=4, variable=question_22)
button_22_4.grid(row=4, column=4, padx=10, pady=10)

# Question 23
info_23 = tk.LabelFrame(root, borderwidth=0, highlightthickness=0, padx=10, pady=10)
info_23.pack()
question_23 = tk.IntVar(info_23)
question_23.set("Президент")
label_23 = tk.Label(info_23, text="23. Алишер Қодиров, Ўзбекистон «Миллий тикланиш» демократик партияси етакчиси")
label_23.grid(row=4, column=0, padx=10, pady=10)
button_23_1 = tk.Radiobutton(info_23, text="1", value=1, variable=question_23)
button_23_1.grid(row=4, column=1, padx=10, pady=10)
button_23_2 = tk.Radiobutton(info_23, text="2", value=2, variable=question_23)
button_23_2.grid(row=4, column=2, padx=10, pady=10)
button_23_3 = tk.Radiobutton(info_23, text="3", value=3, variable=question_23)
button_23_3.grid(row=4, column=3, padx=10, pady=10)
button_23_4 = tk.Radiobutton(info_23, text="4", value=4, variable=question_23)
button_23_4.grid(row=4, column=4, padx=10, pady=10)

# Question 24
info_24 = tk.LabelFrame(root, borderwidth=0, highlightthickness=0, padx=10, pady=10)
info_24.pack()
question_24 = tk.IntVar(info_24)
question_24.set("Президент")
label_24 = tk.Label(info_24, text="24. Баҳром Абдухалимов, Ўзбекистон «Адолат»  демократик партияси етакчиси ")
label_24.grid(row=4, column=0, padx=10, pady=10)
button_24_1 = tk.Radiobutton(info_24, text="1", value=1, variable=question_24)
button_24_1.grid(row=4, column=1, padx=10, pady=10)
button_24_2 = tk.Radiobutton(info_24, text="2", value=2, variable=question_24)
button_24_2.grid(row=4, column=2, padx=10, pady=10)
button_24_3 = tk.Radiobutton(info_24, text="3", value=3, variable=question_24)
button_24_3.grid(row=4, column=3, padx=10, pady=10)
button_24_4 = tk.Radiobutton(info_24, text="4", value=4, variable=question_24)
button_24_4.grid(row=4, column=4, padx=10, pady=10)

# Question 25
info_25 = tk.LabelFrame(root, borderwidth=0, highlightthickness=0, padx=10, pady=10)
info_25.pack()
question_25 = tk.IntVar(info_25)
question_25.set("Президент")
label_25 = tk.Label(info_25, text="25. Улуғбек Иноятов, Ўзбекистон Халқ демократик партияси етакчиси")
label_25.grid(row=4, column=0, padx=10, pady=10)
button_25_1 = tk.Radiobutton(info_25, text="1", value=1, variable=question_25)
button_25_1.grid(row=4, column=1, padx=10, pady=10)
button_25_2 = tk.Radiobutton(info_25, text="2", value=2, variable=question_25)
button_25_2.grid(row=4, column=2, padx=10, pady=10)
button_25_3 = tk.Radiobutton(info_25, text="3", value=3, variable=question_25)
